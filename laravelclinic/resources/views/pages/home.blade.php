...
<div class="container">
    ...
    @foreach($doctors as $doctor)
        ...
        <div class="card p-2" style="width: 18rem;">
            ...
            <img src="{{asset($doctor['image'])}}" class="card-img-top rounded-circle card-image-circle" alt="major">
            <div class="card-body d-flex flex-column gap-1 justify-content-center">
                <h4 class="card-title fw-bold text-center">{{$doctor['title']}}</h4>
                <a href="{{url($doctor['url'])}}" class="btn btn-outline-primary card-button">Browse Doctors</a>
            </div>
        </div>
        @endforeach
                ...
                <li class="splide__slide">
                    ...
                    <div class="card p-2" style="width: 18rem;">
                        ...
                        <div class="card-body d-flex flex-column gap-1 justify-content-center">
                            ...
                            <a href="{{url($doctor['url'])}}" class="btn btn-outline-primary card-button">Book an
                                appointment</a>
                        </div>
